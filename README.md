...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aiotube-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14036&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aiotube-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aiotube` can be installed with:

```
conda install aiotube
```

It is possible to list all of the versions of `aiotube` available on your platform with:
